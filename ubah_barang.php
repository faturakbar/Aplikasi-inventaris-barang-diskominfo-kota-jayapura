...
$barang =tampil_data ("SELECT * FROM barang JOIN jenis_barang ON barang.kode_jenis = 
                      ...
                      uraian.kode_rekening  WHERE kode_barang = '$kode_barang'") [0];	
            ...
            <div class="card-header py-3">
              ...
              <form action="" method="post" >
                ...
                <div class="form-group">               
                    ...
                    <input type="text"  name="kode_barang" class="form-control" id="kode_barang" placeholder="Masukkan Kode Barang"  value="<?=$kode_barang;?>" readonly>
                </div>       
                <div class="form-group">               
                ...
                <div class="form-group">               
                    ...
                    <?php
                       ...
                       foreach ($uraian as $data) :
                                if ($barang['kode_rekening']==$data['kode_rekening']) {
                                    $select="selected"; 
                                    }else{
                                    $select="";
                                    }
                                    ?>
                        <option value="<?= $data['kode_rekening'];?>"
                        <?= $select;?>><?= $data['uraian'];?></option>
                        <?php  endforeach; ?>
                    </select>
                </div>        
                ...
                <div class="form-group">               
                    ...
                    <?php
                        if ($barang['satuan']=='Unit') echo "<option value='Unit' selected>Unit</option>";
                        else echo "<option value='Unit'>Unit</option>";  
                        if ($barang['satuan']=='Buah') echo "<option value='Buah' selected>Buah</option>";
                        else echo "<option value='Buah'>Buah</option>";  
                        if ($barang['satuan']=='Pcs') echo "<option value='Pcs' selected>Pcs</option>";
                        else echo "<option value='Pcs'>Pcs</option>";
                        if ($barang['satuan']=='Pak') echo "<option value='Pak' selected>Pak</option>";
                        else echo "<option value='Pak'>Pak</option>";  
                    ?> 
                    </select>
                </div>  
                 <div class="form-group">               
                    <label for="tipe">Tipe</label>
                    <input type="text"  name="tipe" class="form-control" id="tipe" placeholder="Masukkan Nama Barang" required="required" value="<?= $barang["tipe"]; ?>" >
                </div>    
                 <div class="form-group">               
                    <label for="merek">Merek</label>
                    <input type="text"  name="merek" class="form-control" id="merek" placeholder="Masukkan Nama Barang" required="required" value="<?= $barang["merek"]; ?>" >
                </div>    
               <!-- /.card-body -->               
