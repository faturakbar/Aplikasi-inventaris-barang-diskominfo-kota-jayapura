...
function tambah_program ($data) {
    ...
    $kode_program2 = $data['kode_program2'];
    $kode_program3 = $data['kode_program3'];

    $gabung_kode_program = $kode_program1.".".$kode_program2.".".$kode_program3;
...
function tambah_kegiatan ($data) {
    ...
    $kode_kegiatan2 = $data['kode_kegiatan2'];
    $kode_kegiatan3 = $data['kode_kegiatan3'];
    $kode_kegiatan4 = $data['kode_kegiatan4'];
    $kode_kegiatan5 = $data['kode_kegiatan5'];

    $gabung_kode_kegiatan = $kode_kegiatan1.".".$kode_kegiatan2.".".$kode_kegiatan3.".".$kode_kegiatan4."."
    						.$kode_kegiatan5;
...
function tambah_sub_kegiatan ($data) {
    ...
    $kode_sub_kegiatan2 = $data['kode_sub_kegiatan2'];
    $kode_sub_kegiatan3 = $data['kode_sub_kegiatan3'];
    $kode_sub_kegiatan4 = $data['kode_sub_kegiatan4'];
    $kode_sub_kegiatan5 = $data['kode_sub_kegiatan5'];
    $kode_sub_kegiatan6 = $data['kode_sub_kegiatan6'];

    $gabung_kode_sub_kegiatan = $kode_sub_kegiatan1.".".$kode_sub_kegiatan2.".".$kode_sub_kegiatan3.".".
    						$kode_sub_kegiatan4.".".$kode_sub_kegiatan5.".".$kode_sub_kegiatan6;
...
function tambah_detail_inventaris ($data) {
    ...
    // ambil data dari tiap elemen dalam form 
    $kode_inventaris = $data['kode_inventaris'];  
    $no_seri= (int)htmlspecialchars($data['no_seri']);
